...
proc request*(url: string, httpMethod: string, extraHeaders = "",
  ...
  ## FOOO
  var s  = socks4a( # Dies ist SOCKS version 4. NUR tcp und IP adressen!
                          ...
                          targetDns = hostUrl.hostname , # die ip des rechners zu dem verbunden werden soll
...
echo getContent("http://getip.111mb.de")
